        ...
        {myRequests.map((ticket) => (
          <Paper
            ...
            sx={{
              ...
              "&:hover": onTicketClick
                ? { borderColor: "rgba(96,165,250,0.28)", transform: "translateY(-1px)" }
                : undefined,
            }}
          >
            <Box
            ...
            >
              <Box sx={{ minWidth: 0, display: "flex", flexDirection: "column", justifyContent: "center" }}>
                ...
                <Typography fontWeight={800} mt={0.65} sx={{ lineHeight: 1.3 }}>
                  {ticket.title}
                </Typography>
                ...
                <Stack direction="row" spacing={1} mt={0.95} flexWrap="wrap" useFlexGap>
                  ...
                  {ticket.reportName ? (
                    <Chip size="small" label={ticket.reportName} variant="outlined" />
                  ) : null}
                  {ticket.reportingMonth ? (
                    <Chip size="small" label={ticket.reportingMonth} variant="outlined" />
                  ) : null}
                </Stack>
              </Box>
              ...
              <Box
                sx={{
                  ...
                  borderTop: { xs: "1px solid rgba(148,163,184,0.10)", md: "none" },
                  display: "flex",
                  alignItems: "center",
      ...
      {myRequests.length === 0 ? (
        ...
        >
          ...
          <Typography color="text.secondary" mt={0.5}>
            Your submitted change and reporting/data requests will appear here.
          </Typography>
        </Paper>
      ) : null}
    </Box>
