      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" mb={1.5}>
        <Box minWidth={0}>
          ...
          <Typography variant="body2" color="text.secondary" mt={0.25}>
            Where requests are in the workflow
          </Typography>
        </Box>
      ...
      >
        <Box sx={{ width: "100%", height: 220, position: "relative" }}>
          <ResponsiveContainer width="100%" height="100%">
            <PieChart>
              <Pie data={chartData} dataKey="value" nameKey="name" innerRadius={63} outerRadius={88} paddingAngle={3} stroke="none">
                {chartData.map((entry) => (
          ...
          <Stack position="absolute" inset={0} alignItems="center" justifyContent="center" pointerEvents="none">
            <Typography sx={{ fontSize: "1.65rem", fontWeight: 850, lineHeight: 1 }}>{total}</Typography>
        ...
        <Box sx={{ minWidth: 0 }}>
          <Box
            sx={{
              display: "grid",
              gridTemplateColumns: "minmax(0, 1fr) 32px 48px",
              columnGap: 1.5,
              mb: 0.5,
              px: 1,
            }}
          >
            ...
            <Typography variant="caption" color="text.secondary" fontWeight={700} textAlign="right">#</Typography>
            <Typography variant="caption" color="text.secondary" fontWeight={700} textAlign="right">SHARE</Typography>
          </Box>
          <Stack spacing={0.45}>
            {statuses.map((status) => {
