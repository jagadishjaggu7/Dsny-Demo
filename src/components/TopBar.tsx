    ...
    >
      ...
      <Toolbar sx={{ minHeight: "104px !important", px: { xs: 2.25, md: 3.5 }, position: "relative", zIndex: 1 }}>
        <Box display="flex" alignItems="center" gap={{ xs: 1.5, md: 2.1 }}>
          ...
          <Box>
            <Typography sx={{ fontSize: { xs: "1.2rem", md: "1.38rem" }, lineHeight: 1.05, fontWeight: 900, letterSpacing: -0.35, textShadow: "0 5px 18px rgba(0,0,0,0.40)" }}>
              DSNY RequestHub
            </Typography>
        ...
        <Select
          ...
          sx={{ mr: { xs: 1, md: 1.5 }, minWidth: 130, color: "white", "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(148,163,184,0.26)" }, "& .MuiSvgIcon-root": { color: "#BFDBFE" }, bgcolor: "rgba(15,23,42,0.46)" }}
        >
          <MenuItem value="admin">Admin</MenuItem>
          <MenuItem value="requester">Requester</MenuItem>
        </Select>
        <Avatar sx={{ width: 44, height: 44, bgcolor: "primary.main", fontWeight: 900, boxShadow: "0 8px 20px rgba(37,99,235,0.26)" }}>
          {role === "admin" ? "A" : "R"}
        </Avatar>
      </Toolbar>
    </AppBar>
